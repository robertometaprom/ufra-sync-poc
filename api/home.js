...
.shx-header-search{flex:1;max-width:460px;min-width:220px;position:relative}.shx-header-search input{width:100%;border:1px solid #ddd2c7;border-radius:999px;padding:11px 16px 11px 38px;background:#fffaf5;font-size:14px;outline:none}.shx-header-search:before{content:'⌕';position:absolute;left:14px;top:50%;transform:translateY(-52%);font-size:19px;color:#756b63;pointer-events:none}.topbar .shell{gap:18px}.top-actions{flex-shrink:0}
...
try{
  ...
  if(topbarShell&&catalogSearch&&!document.getElementById('shxHeaderSearch')){
    const wrap=document.createElement('label');wrap.className='shx-header-search';wrap.setAttribute('aria-label','Buscar productos');
    ...
    const actions=topbarShell.querySelector('.top-actions');topbarShell.insertBefore(wrap,actions||null);
    input.addEventListener('input',()=>{catalogSearch.value=input.value;catalogSearch.dispatchEvent(new Event('input',{bubbles:true}))});
