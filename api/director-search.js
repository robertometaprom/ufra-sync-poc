...
export default async function handler(req,res){
 try{
  ...
  // For luxury discovery, higher-priced prestige fragrances are generally more useful than the cheapest match.
  // This is only merchandising order, never a claim of popularity.
